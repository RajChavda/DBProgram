...
NSString * const DataBaseName  = @"StorefrontDb"; // Paas Your DataBase Name Over here
...
-(BOOL) createEditableCopyOfDatabaseIfNeeded
{
    ...
    if (!success) {
        UIAlertView *alert = [[UIAlertView alloc] initWithTitle:@"Storefront" message:@"Failed to create writable database" delegate:self cancelButtonTitle:@"Cancel" otherButtonTitles:nil];
        [alert show];
    }
    return success;
}
